...
png("./exdata_plotting1/submit/plot1.png",height = 480, width = 480)
hist(dataUse$Global_active_power,col="red",xlab="Global Active Power (kilowats)", main="Global Active Power")
dev.off()
